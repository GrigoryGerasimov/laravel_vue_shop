                ...
                <div class='form-group d-flex flex-row align-items-baseline'>
                    ...
                    >
                        ...
                        @foreach($gendersList as $gender)
                            <option value='{{ $gender->id }}' @if(($gender->id == $user->gender->id) || (old('gender_id') == $gender->id)) selected @endif>{{ $gender->title }}</option>
                        @endforeach
                    </select>
                </div>
                @error('gender_id')
            ...
            <div class='my-3'>
                <div class='form-group d-flex flex-row align-items-baseline'>
                    ...
                    <input
                        ...
                        id='unit_number'
                        name='unit_number'
                        value='{{ old('unit_number') ?? $user->unit_number }}'
                ...
                <div class='form-group d-flex flex-row align-items-baseline'>
                    ...
                    >
                        ...
                        @foreach($countriesList as $country)
                            <option value='{{ $country->id }}' @if(($country->id == $user->country->id) || (old('country_id') == $country->id)) selected @endif>{{ $country->title }}</option>
                        @endforeach
                    </select>
                </div>
                @error('country_id')
