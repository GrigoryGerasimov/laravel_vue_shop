            ...
            <div class="container-fluid pl-0">
                <div class="row mb-2">
                    <div class="col-sm-6" role="button">
                        ...
                        <a href="{{ route('users.show', $user) }}" class="text-dark ml-1">Back</a>
                    </div>
                    <div class="col-sm-6">
                        ...
                        >
                            ...
                            @foreach($gendersList as $gender)
                                <option value='{{ $gender->id }}'
                                        @if(($gender->id == $user->gender->id) || (old('gender_id') == $gender->id)) selected @endif>{{ $gender->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('gender_id')
                        ...
                        >
                            ...
                            @foreach($countriesList as $country)
                                <option value='{{ $country->id }}'
                                        @if(($country->id == $user->country->id) || (old('country_id') == $country->id)) selected @endif>{{ $country->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('country_id')
                ...
                <div class='mt-5'>
                    <div class='form-group d-flex flex-row flex-wrap align-items-baseline'>
                        ...
                        <input
                            ...
                            id='address_line_1'
                            name='address_line_1'
                            value='{{ old('address_line_1') ?? $user->address->address_line_1 }}'
                ...
                <div class='my-3'>
                    <div class='form-group d-flex flex-row flex-wrap align-items-baseline'>
                        ...
                        <input
                            ...
                            id='unit_number'
                            name='unit_number'
                            value='{{ old('unit_number') ?? $user->address->unit_number }}'
                ...
                <div class='my-3'>
                    <div class='form-group d-flex flex-row flex-wrap align-items-baseline'>
                        ...
                        >
                            ...
                            @foreach($countriesList as $country)
                                <option value='{{ $country->id }}'
                                        @if(($country->id == $user->address->country->id) || (old('address_country_id') == $country->id)) selected @endif>{{ $country->title }}</option>
                            @endforeach
                        </select>
                    </div>
