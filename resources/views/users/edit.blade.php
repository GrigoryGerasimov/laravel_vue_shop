            ...
            <div class="container-fluid pl-0">
                <div class="row mb-2">
                    <div class="col-sm-6" role="button">
                        ...
                        <a href="{{ route('colors.show', $color) }}" class="text-dark ml-1">Back</a>
                    </div>
                    <div class="col-sm-6">
        ...
        <form action='{{ route('colors.update', $color) }}' method='POST'
            ...
            <div class='my-5'>
                <div class='input-group w-50'>
                    ...
                    <input class='form-control @error('title') is-invalid @enderror' id='title' name='title' value='{{ old('title') ?? $color->title }}'
                           placeholder='title'/>
                </div>
                @error('title')
            ...
            <div class='my-5'>
                <div class='input-group w-50'>
                    ...
                    <input class='form-control @error('hex') is-invalid @enderror' id='hex' name='hex'
                           value='{{ old('hex') ?? $color->hex }}' placeholder='hex'/>
                </div>
                @error('hex')
                <p class='text-danger mt-3'>{{ $message }}</p>
                @enderror
