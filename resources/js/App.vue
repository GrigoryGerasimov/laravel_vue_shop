...
export default defineComponent({
    ...
    methods: {
        ...
        addUnit(article, size, qty) {
            ...
            if (~existingPositionIndex && (this.unitsToReserve[existingPositionIndex].size === newUnit.size)) {
        ...
        handleQtyReserve(id, size, qty) {
            this.addUnit(id, size, qty)
            this.qtyToReserve = 1
        }
    },
